({
    doinit : function(component, event, helper){
        ...
        helper.getVisitRequestForm(component, recordId, function(err, result){
            component.set('v.RequestType', result);
        });

        helper.getApprovalForm(component, recordId, function(err, approved){
            component.set('v.Approval', approved);
