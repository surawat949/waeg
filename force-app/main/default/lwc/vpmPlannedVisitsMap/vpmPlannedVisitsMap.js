        ...
        getVisitPlanning({startDate : this.SearchStartDate, endDate : this.SearchEndDate}).then(result=>{
            ...
            if(result.length > 0){
                ...
                for(var i=0;i<result.length;i++){
                    if(i==0){
                        if(result[i].Account__r.TACTICOM_SOF__c!=undefined){
                            if(result[i].Account__r.TACTICOM_SOF__c == 'Sub-area 1'){
                                this.mapMaker = [...this.mapMaker,
                                    {
                                        ...
                                        value : result[i].Id,
                                        description : '<b>Hoya Account Id : </b>'+result[i].Account__r.Hoya_Account_ID__c +
                                                        '<br><b>Account Name : </b>'+result[i].Account__r.Name +
                                                        '<br><b>Street : </b>'+result[i].Account__r.Shop_Street__c +
                                                        '<br><b>City : </b>'+result[i].Account__r.Shop_City__c +
                                                        '<br><b>State : </b>'+result[i].Account__r.Shop_State__c +
                                                        '<br><b>Postal Code : </b>'+result[i].Account__r.Shop_Postal_Code__c + 
                                                        '<br><b>Sub-area : </b>'+result[i].Account__r.TACTICOM_SOF__c,
                                    }
                                    
                                ];
                            }else if(result[i].Account__r.TACTICOM_SOF__c=='Sub-area 2'){
                                this.mapMaker = [...this.mapMaker,
                                    {
                                        location : {
                                            //Latitude : result[i].Account__r.sf_latitude__c,
                            ...
                            }else if(result[i].Account__r.TACTICOM_SOF__c == 'Sub-area 3'){
                                this.mapMaker = [...this.mapMaker,
                                    {
                                        location : {
                                            //Latitude : result[i].Account__r.sf_latitude__c,
                            ...
                            }else if(result[i].Account__r.TACTICOM_SOF__c == 'Sub-area 4'){
                                this.mapMaker = [...this.mapMaker,
                                    {
                                        location : {
                                            //Latitude : result[i].Account__r.sf_latitude__c,
                            ...
                            }else if(result[i].Account__r.TACTICOM_SOF__c == 'Sub-area 5'){
                                this.mapMaker = [...this.mapMaker,
                                    {
                                        location : {
                                            //Latitude : result[i].Account__r.sf_latitude__c,
                                ...
                                this.mapMaker = [...this.mapMaker,
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity : .7,
                                            strokeWeight: 1,
                                            scale : 1.6,     //this is other number
