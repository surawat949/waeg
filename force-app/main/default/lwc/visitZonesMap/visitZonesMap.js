...
export default class VisitZonesMap extends LightningElement {
    ...
    @wire(getAccountDataList, {ZoneName : '$VisitZone'})
        ...
        if(data){
            ...
            if(data.length > 0){
                data.forEach(dataItem=>{
                    let descritptionVal = '<strong>Hoya Account Id : </strong>'+dataItem.Hoya_Account_Id + '<br>' + '<strong>Name : </strong>'+dataItem.AccountName + 
                                                    '<br><strong>Street : </strong>'+dataItem.AccountStreet +'<br><strong>City : </strong>' + dataItem.AccountCity +
                                                    '<br><strong>State : </strong>'+dataItem.AccountState + '<br><strong>Postal Code : </strong>'+dataItem.AccountPostalCode +
                                                    '<br><strong>Country : </strong>'+dataItem.AccountCountry + '<br><strong>Visit Zone : </strong>'+dataItem.VisitZone;
                ...
                this.showToast('Warning', 'Warning', 'No Account Data Found');
            }
            this.showMap = true;
