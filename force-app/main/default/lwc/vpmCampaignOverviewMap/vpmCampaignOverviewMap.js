        ...
        getVisitsCampaignMap({CampaignId : this.picklistValue}).then(result=>{
            ...
            if(result.length > 0){
                for(var i=0;i<result.length;i++){
                    let Campaign_present = '';

                    if(result[i].IsPresent == true){
                        Campaign_present = 'Yes';
                    }else{
                        Campaign_present = 'No';
                    }
                    if(i==0){
                                ...
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .7,
                                            strokeWeight: 1,
                                            scale: 1.2,         //campaign present and have visit planned
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
                                        description :   '<b>Campaign Name : </b>'+result[i].CampaignName + '<br><b>Hoya Account ID : </b>' + result[i].AccountHoyaAccountId + 
                                                        '<br><b>Street : </b>' + result[i].AccountShippingStreet + '<br><b>City : </b>'+result[i].AccountShippingCity + 
                                                        '<br><b>State : </b>' + result[i].AccountShippingState + '<br><b>Campaign Presented : </b>' + Campaign_present,
                                    }
                                ];
                            }else{
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .7,
                                            strokeWeight: 1,
                                            scale: 0.9,         //campaign present but have no visit planned
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
                                ...
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        location : {
                                            //Latitude : result[i].AccountShippingLatitude,
                                            //ongitude : result[i].AccountShippingLongitude,
                                            Street : result[i].AccountShippingStreet,
                                            City : result[i].AccountShippingCity,
                                            State : result[i].AccountShippingState,
                                            PostalCode : result[i].AccountShippingPostalCode,
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .6,
                                            strokeWeight: 1,
                                            scale: 1.2,             //campaign not presented but have visited planned
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
                                ...
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .6,
                                            strokeWeight: 1,
                                            scale: 0.9,             //campaign not present have no visit planned
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
                                ...
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .7,
                                            strokeWeight: 1,
                                            scale: 1.2,         //visited planned and have campaign presented
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
                                ...
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .7,
                                            strokeWeight: 1,
                                            scale: 0.9,         //campaign presented but have no visit planned
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
                                ...
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .6,
                                            strokeWeight: 1,
                                            scale: 1.2,             //visit planned and have no campaign presented
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
                                ...
                                this.mapMarker = [...this.mapMarker, 
                                    {
                                        ...
                                        mapIcon : {
                                            ...
                                            fillOpacity: .6,
                                            strokeWeight: 1,
                                            scale: 0.9,             //campaign not presented, have no visit plan
                                        },
                                        icon : 'standard:campaign',
                                        title : result[i].AccountNameText,
                                        value : result[i].AccCampaignName,
