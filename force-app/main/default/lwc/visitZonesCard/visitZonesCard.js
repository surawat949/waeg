...
export default class VisitZonesCard extends NavigationMixin(LightningElement) {
    ...
    custLabel ={
        tabLabelClose,ButtonCancel,Confirm_Action,SFDC_V2_Confirm,SFDC_V2_Seg,SFDC_V2_SV,SFDC_Visits_Planned,
    ...
    connectedCallback() {
        if(this.record.Seiko_Network__c == 'Seiko Vision Specialist' || this.record.Seiko_Network__c == 'Hoya Center'){
