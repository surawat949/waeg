...
import getDynamicTableDataList from '@salesforce/apex/serviceFlow_CustomerSalesReturns.GetWrapperOfSObjectFieldColumnActionValues';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { subscribe, unsubscribe, onError } from 'lightning/empApi';
import { NavigationMixin } from 'lightning/navigation';
export default class SeviceFlow_CustomerSalesReturns extends NavigationMixin(LightningElement) {
    ...
    async invokeApexMethods() {
        ...
        try {
            const result = await getDynamicTableDataList({
                TableName: 'customer_sales_returns',
            ...
            if (result != null) {
                ...
                let actions = [
                    ...
                    { label: 'View', name: 'View_in_salesforce' },
                ...
                if(sObjectRelatedFieldListValuesTemp.length > 0){
